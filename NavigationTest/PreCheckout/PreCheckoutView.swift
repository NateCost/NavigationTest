...
final class PreCheckoutView: UIViewController {
    let output: PreCheckoutViewOutput

    private let button = UIButton()

    init(output: PreCheckoutViewOutput) {
        self.output = output
    ...
    func setupUI() {
        ...
        button.setTitle("tap me 2", for: .normal)
...
protocol PreCheckoutViewOutput {
    func proceedDidTap()
}
